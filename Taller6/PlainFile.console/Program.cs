...
public class Program
{
    private static void Main(string[] args)
    {
        ...
        PersonHandler PM = new PersonHandler(user);
        Menu(PM);
    }
    ...
    private static void Menu(PersonHandler PM)
    {
        string option;
    ...
    private static void AddPerson(PersonHandler PM)
    {
        try
        {
            Console.Write("ID: ");
    ...
    private static void EditPerson(PersonHandler PM)
    {
    ...
    private static void DeletePerson(PersonHandler PM)
    {
